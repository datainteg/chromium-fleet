...
const config = {
  ...
  allowInstall: parseBoolean(process.env.ALLOW_INSTALL, false),
  allowUninstall: parseBoolean(process.env.ALLOW_UNINSTALL, false),
  allowActions: parseBoolean(process.env.ALLOW_ACTIONS, true),
  allowDestructiveActions: parseBoolean(process.env.ALLOW_DESTRUCTIVE_ACTIONS, false),
